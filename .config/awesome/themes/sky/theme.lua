...
theme.tasklist_floating_icon = "/usr/local/share/awesome/themes/sky/layouts/floating.png"
...
-- MISC
theme.wallpaper_cmd         = { "awsetbg /usr/local/share/awesome/themes/sky/sky-background.png" }
